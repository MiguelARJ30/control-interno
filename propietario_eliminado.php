                        ...
                        <tbody>
                            <?php foreach ($propietarios as $propietario): ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#eliminarModal<?php echo $propietario['id_propietario']; ?>">Eliminar</button>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ¿Está seguro de que desea eliminar este propietario? Esto cambiará su estado a "Eliminado".
                                            </div>
