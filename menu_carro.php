        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Registrar Carro</h5>
                        <a href="registro_carro.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Ver Carros</h5>
                        <a href="listado_carros.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="editar_carro.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Eliminar carros</h5>
                        <a href="carro_eliminado.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    <img src="imagenes/habilitar.png" class="card-img-top" alt="Card image" style="width: 250px; height: 250px;">
                    <div class="card-body">
                        <h5 class="card-title">Habilitar carros</h5>
                        <a href="activar_carro.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
        </div>
