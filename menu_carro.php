...
<body>
    ...
    <div style="background-color: #472681; color: white; width: 300px; height: 50px; border-radius: 50px; display: flex; align-items: center; justify-content: center;">
        <p style="font-size: 26px;">VEHICULO</p>
        </div>
    <div class="row">
            <!-- Tarjetas -->
            ...
            <?php endif; ?>
            <?php if ($rol == 'admin' || $rol == 'contaduria') : ?>
                <a class="btn btn-primary" href="carro_eliminado.php" style="width: 300px; height: 350px; border-radius: 50px; background-color: white; border: 3px solid #472681; margin: 4rem; display: flex; justify-content: center; flex-direction: column; align-items: center;">
            ...
            <?php endif; ?>
            <?php if ($rol == 'admin' || $rol == 'contaduria') : ?>
                <a class="btn btn-primary" href="activar_carro.php" style="width: 300px; height: 350px; border-radius: 50px; background-color: white; border: 3px solid #472681; margin: 4rem; display: flex; justify-content: center; flex-direction: column; align-items: center;">
