        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Registrar Trabajador</h5>
                        <a href="registro_trabajador.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Ver Trabajador</h5>
                        <a href="ver_trabajador.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="editar_trabajador.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Eliminar Trabajador</h5>
                        <a href="trabajador_eliminado.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 300px; height: 350px;">
                    <!-- <img src="imagenes/habilitar.png" class="card-img-top" alt="Card image" style="width: 250px; height: 250px;"> -->
                    <div class="card-body">
                        <h5 class="card-title">Habilitar Trabajador</h5>
                        <a href="activar_trabajador.php" class="btn btn-primary">Ver más</a>
                    </div>
                </div>
            </div>
        </div>
