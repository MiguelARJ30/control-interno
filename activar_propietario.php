                        ...
                        <tbody>
                            <?php foreach ($propietarios as $propietario): ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#eliminarModal<?php echo $propietario['id_propietario']; ?>" style="border-radius: 50px;">Activar</button>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                               <p>¿Está seguro de que desea activar este propietario?</p>
                                                (Recuerde que al activar al propietario debera activar de igual forma los vehiculos)
                                            </div>
