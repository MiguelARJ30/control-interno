...
<body>
    ...
    <div style="background-color: #472681; color: white; width: 300px; height: 50px; border-radius: 50px; display: flex; align-items: center; justify-content: center;">
        <p style="font-size: 26px;">ASIGNACIÓN</p>
    </div>
    <div class="row">
            <!-- Tarjetas -->
            <?php if ($rol == 'admin' || $rol == 'contaduria') : ?>
                <a class="btn btn-primary" href="registro_asignacion.php" style="width: 300px; height: 350px; border-radius: 50px; background-color: white; border: 3px solid #472681; margin: 4rem; display: flex; justify-content: center; flex-direction: column; align-items: center;">
                    <img src="imagenes/asignacion_1.png" class="card-img-top" alt="Card image" style="width: 230px; height: 230px; margin: 1rem;">
                    <div class="card-body">
            ...
            <?php endif; ?>
            <?php if ($rol == 'admin' || $rol == 'contaduria') : ?>
                <a class="btn btn-primary" href="ver_asignacion.php" style="width: 300px; height: 350px; border-radius: 50px; background-color: white; border: 3px solid #472681; margin: 4rem; display: flex; justify-content: center; flex-direction: column; align-items: center;">
                    <img src="imagenes/asignacion.png" class="card-img-top" alt="Card image" style="width: 230px; height: 230px; margin: 1rem;">
                    <div class="card-body">
            ...
            <?php endif; ?>
            <?php if ($rol == 'admin' || $rol == 'contaduria') : ?>
                <a class="btn btn-primary" href="asignacion_eliminado.php" style="width: 300px; height: 350px; border-radius: 50px; background-color: white; border: 3px solid #472681; margin: 4rem; display: flex; justify-content: center; flex-direction: column; align-items: center;">
