...
$sql = "SELECT c.*, e.estado FROM conductor c JOIN estado e ON c.id_estado = e.id_estado WHERE c.id_estado = 1";
$stmt = $pdo->query($sql);
            ...
            <?php foreach ($conductores as $conductor): ?>
                    ...
                    <td><?php echo htmlspecialchars($conductor['id_conductor']); ?></td>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-danger btn-sm" onclick="confirmarEliminacion(<?php echo $conductor['id_conductor']; ?>)">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <script>
        ...
        function confirmarEliminacion(id_conductor) {
            ...
            if (confirmacion) {
                ...
                window.location.href = "eliminar_conductor.php?id=" + id_conductor;
            }
        }
    </script>
